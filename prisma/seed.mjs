...
作為消費者，我們的責任是保持知情，做出有意識的選擇，並支持更透明、更負責任的食品供應鏈。`,
  },
  {
    ...
    excerpt: "許多消費者購買食品時，往往被吸引人的外觀所迷惑。但食品安全專家提醒，商品的顏值並不能代表其營養價值和安全性。",
    categoryId: "food-safety",
    authorId: "author-editorial",
    status: "published",
    publishedAt: "2026-04-20",
  ...
  },
  {
    ...
    title: "學會分辨飢餓信號",
    slug: "hunger-signals",
    excerpt: "你是否經常吃但仍感到飢餓？真正的生理飢餓和情緒性進食是不同的，理解差異能幫助你建立更健康的飲食習慣。",
  ...
  },
  {
    ...
    excerpt: "現代人生活快節奏，外食成為常態。但許多外食選項暗含高熱量、高鈉的陷阱，對代謝造成無形負擔。",
  ...
  },
  {
    ...
    excerpt: "從早餐文化到夜市美食，台灣飲食反映了這片土地的多元性和創意。重新認識身邊的食物，也是在重新認識生活。",
  ...
  },
  {
    ...
    excerpt: "有機食品的價格通常更高，但它是否真的比傳統食品更安全？科學研究顯示，答案比你想像的複雜。",
    categoryId: "food-safety",
    authorId: "author-editorial",
    status: "published",
  ...
  },
  {
    ...
    excerpt: "超市食品背面的營養標籤看起來複雜，但掌握幾個要點，你就能把資訊變成簡單易懂的購物判斷。",
    categoryId: "nutrition",
    authorId: "author-editorial",
    status: "published",
